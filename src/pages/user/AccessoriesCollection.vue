  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <section class="bg-white py-8 border-b">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold text-gray-900">Accessories</h1>
        <p class="mt-2 text-gray-600">Complete your look with our stylish accessories</p>
      </div>
    </section>
        ...
        <div class="flex flex-col lg:flex-row gap-8">
          ...
          <div class="flex-1">
            ...
            <div v-if="filteredProducts.length === 0" class="text-center py-12">
              <p class="text-gray-500 text-lg">No accessories found</p>
            </div>
          </div>
        </div>
      </div>
